...
Okay, now it's time for the truth. I've told you a small lie and left out an important part of the law of addition. I'll show you what I mean. Let's define our sample space to be $S$ = {A,B,C}, and suppose each outcome has a probability of 1/3. Define $C_1 = \{A,B\}$ or $C_2 = \{B,C\}$. We would like to know the probability of our outcome landing in C_1 or C_2. However, remember our current version of the "law of or" only works for mutually exclusive sets, and $C_1 \cap C_2 = \{B\}$. That is to say they aren't mutually exclusive. We need to make a small addition to the law of addition. 