...
::: {.example}
Let's take a look at an example that will give us another view of things. Suppose we flip two coins and, as in previous examples, our sample space is $S = \{TT,TH,HT,TT\}$. Suppose our probability set operator assigns to each a probability of 1/4.
:::