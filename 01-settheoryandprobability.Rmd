...
Before we get into it, we aren't going to learn set theory in it's entirety. That would be overly (and hilariously) ambitious. What we are going to learn will make understanding later sections easier, get your brain warmed up, and make it a bit easier to understand set notation in other circumstances. The first step in conducting a random experiment is clearly defining all the possible outcomes of your sampling procedure. As previously mentioned, this set of potential outcomes is referred to as the **sample space**. 

For example, suppose we have five different possible outcomes (a.k.a., elements) in our sample space - A, B, C, D, and E. Calling our set $S$ ($S$ for Sample!), and using *set notation*, we would describe our sample space like this
