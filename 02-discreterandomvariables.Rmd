...
The concept of independence is found frequently within the field of statistics. As you read on you will find that it is essential to the derivation, understanding, and validity of some of the most fundamental statistical theories. Therefore, it is nice to have a deeper understanding of it. The goal if this section is therefore to frame an intuition of the independence of random variables. A deeper mathematical understanding shall be saved for your inevitable foray into mathematical statistics (no doubt after being inspired by this book to master the topic).

In the last chapter, we discussed the concept of the independence of _events_ in a random experiment. We shall now discuss independence as it pertains to random variables. Suppose we have two random variables $X_1$ and $X_2$.
