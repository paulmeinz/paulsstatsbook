...
::: {.example}
Suppose we are flipping 4 fair coins - each with $p=1/2$ probability of flipping heads. Further suppose that we assign $H$ the value of 1 and $T$ the value of zero, and sum the flipped outcomes up. Let's call this new random variable $Z$. What is the probability of flipping zero heads - $P(Z = 0)$? What is the probability of flipping _at least_ 1 head - $P(Z \geq 1)$? What are the expectation and variance of this new random variable $Z$.
...
\end{align}
$$
where the last step follows because a number raised to the 0th power is 1. Therefore, $P(Z = 0) = 1/16$.
