...
::: {.example}
Suppose we flip two coins - where a flip of $H$ yields a value of 1 and a flip of $T$ yields a value of zero. Call these two random variables $X_1$ and $X_2$, respectively. What is the expectation of their sum? To demonstrate why property four is so useful, we'll do this the hard way and the easy way.
...
\end{cases}
$$
Unfortunately, these pmfs won't suffice to calculate the expectation of $X_1 + X_2$.
