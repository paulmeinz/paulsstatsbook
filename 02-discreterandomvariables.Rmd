...
It is a measure of how the outcomes of $X$ are spread out about their mean (a.k.a. their _dispersion_). There are indeed many ways you can measure the dispersion of a random variable. New students, for example, often wonder why we don't just calculate $E(X - \mu)$ as a measure of dispersion, and to answer this question, we'll do the calculation ourselves.
