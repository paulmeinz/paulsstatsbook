...
\end{cases}
$$
This is an example of a **discrete uniform distribution** - which assigns an equivalent amount of probability to each outcome on the space of the random variable.

Let's calculate the expectation of our random variable
:::