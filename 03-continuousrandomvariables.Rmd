...
Because of the equivalence described above, we will heretofore simply refer to the two theorems above as properties of the expectation aexd variance, respectively, rather than belonging to some class of discrete or continuous random variables. In other words, we may use the properties of the expectation and variance for random variables generally (if those random variables have expectations and variance; we'll look at an example of a random variable that doesn't have these in the next section).
