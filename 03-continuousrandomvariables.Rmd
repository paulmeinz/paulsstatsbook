...
$$
Let's try something similar, we are going to divide the area under our pdf into parts. The area of each of these regions will act analogously to our p(x). For example, in the plot below, I've divided the area under the pdf into four regions - each corresponding to a range of $x$ of equivalent length. Each of the regions has the width $\frac{1}{4}\sqrt{2}$.  
...
The area of each of these four regions corresponds to the probability that $X$ falls within its corresponding range of $x$. For example, the first region represents $P(X < \frac{1}{4}\sqrt{2})$ and the last region represents $P(\frac{3}{4}\sqrt{2} < X < \frac{4}{4}\sqrt{2})$. Using \@ref(eq:fundamental), we can calculate the latter as
