...
In practice, we will sometimes want to know the probability of $X$ falling in a range dissimilar from the cdf. We may want to know, for example, $P(a < X < b)$ or $P(X > a)$. In our next example we frame the intuition of a some common scenarios. If you've forgotten, now may be the time to review your set notation for continuous sample spaces.