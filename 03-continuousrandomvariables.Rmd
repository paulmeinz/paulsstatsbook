...
The values a and b indicate the starting point and the ending point for the integration. They tell us to calculate the area under the curve $f(x)$ from a to b. In our example above, we calculated the integral of $f(x)$ from x = 0 to x = .25. 