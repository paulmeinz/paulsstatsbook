...
The interpretation of independence in the context of continuous random variables is (again!) quite similar to that of discrete random variables. A thorough look into the dependence/independence of continuous random variables would require a little too much integration for our needs. Instead, we'll focus on independence. Later in this book, we'll discuss dependence in the context of correlation and normally distributed random variables (we'll learn about normal distributions in the next section).
